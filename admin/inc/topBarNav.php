<style>
  ...
  button.btn.btn-rounded.badge.badge-light.dropdown-toggle.dropdown-icon {
    transition: background-color 0.3s ease;
    /* Smooth transition effect */
  }


  button.btn.btn-rounded.badge.badge-light.dropdown-toggle.dropdown-icon:hover {
    ...
    <li class="nav-item">
      <div class="btn-group nav-link">
        <button type="button" class="btn btn-rounded badge badge-light dropdown-toggle dropdown-icon" data-toggle="dropdown">
          ...
          <span class="ml-3 user-name"><?php echo ucwords($_settings->userdata('firstname') . ' ' . $_settings->userdata('lastname')) ?></span>
